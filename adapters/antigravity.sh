#!/bin/bash
# cromaiping adapter for Google Antigravity IDE
...
#
# Usage:
#   bash ~/.claude/hooks/cromaiping/adapters/antigravity.sh        # foreground
#   bash ~/.claude/hooks/cromaiping/adapters/antigravity.sh &      # background
...
# --- Start watching ---
info "${BOLD}cromaiping Antigravity adapter${RESET}"
